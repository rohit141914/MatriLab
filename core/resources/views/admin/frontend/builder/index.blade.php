                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="name" required type="text" value="{{ $pdata->name }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>@lang('Page Slug')</label>
                                        <input class="form-control" name="slug" required type="text" value="{{ $pdata->slug }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <li class="highlight icon-move clearfix">
                                    ...
                                    @if ($secs['builder'])
                                        <div class="float-end d-inline-block manage-content">
                                            <a class="btn btn-outline-light text-center text-white cog-btn" href="{{ route('admin.frontend.sections', $k) }}" target="_blank" title="@lang('Manage Content')">
