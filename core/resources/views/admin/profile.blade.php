                ...
                <div class="card-body p-0">
                    <div class="d-flex p-3 bg--primary align-items-center">
                        <div class="avatar avatar--lg">
                            <img alt="@lang('Image')" src="{{ getImage(getFilePath('adminProfile') . '/' . $admin->image, getFileSize('adminProfile')) }}">
                        </div>
                        <div class="ps-3">
                        ...
                        <div class="row">
                                    ...
                                    <div class="image-upload">
                                        <div class="thumb">
                                            ...
                                            <div class="avatar-edit">
                                                <input accept=".png, .jpg, .jpeg" class="profilePicUpload" id="profilePicUpload1" name="image" type="file">
                            ...
                            <div class="col-xl-6 col-lg-12 col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" name="name" required type="text" value="{{ $admin->name }}">
                                </div>
