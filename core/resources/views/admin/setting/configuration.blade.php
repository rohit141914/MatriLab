                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                                ...
                                <div class="form-group">
                                    <input name="chat_attachment" data-bs-toggle="toggle" data-height="35" data-off="@lang('Disable')" data-offstyle="-danger" data-on="@lang('Enable')" data-onstyle="-success" data-size="large" data-width="100%" type="checkbox" @if ($general->chat_attachment) checked @endif>
                                </div>
                            </li>
