                ...
                <form action="" method="post">
                    ...
                    <div class="card-body">
                        <div class="form-group custom-css">
                            <textarea class="form-control customCss" name="css" rows="10">{{ $fileContent }}</textarea>
                        </div>
                    </div>
...
@endpush
@push('style-lib')
    <link href="{{ asset('assets/admin/css/codemirror.min.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/admin/css/monokai.min.css') }}" rel="stylesheet">
@endpush
@push('script-lib')
