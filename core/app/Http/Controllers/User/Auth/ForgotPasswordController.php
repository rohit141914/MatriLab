...
class ForgotPasswordController extends Controller
{
    ...
    */
    ...
    public function showLinkRequestForm()
    {
        ...
        $forgotPassContent = getContent('forgot_password.content', true);
        return view($this->activeTemplate . 'user.auth.passwords.email', compact('pageTitle', 'forgotPassContent'));
    }
